...
namespace SharedCode
{
	...
	{
		[DataMember(Order = 1)]
		public ShNamePartItemCode[] NamePartSelItem { get; set; } = { ShNamePartItemCode.C_DV_NUMPERIOD, ShNamePartItemCode.C_SX_NUMNUM2, ShNamePartItemCode.C_DV_NAMDASH, ShNamePartItemCode.C_SX_NAMCOPY1 };
